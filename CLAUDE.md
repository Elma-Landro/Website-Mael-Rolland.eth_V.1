...
> `docs/audits/data/patch-application-queue-v113.csv` (**31 artefacts**,
...
> `CANDIDATE — NOT APPLIED` string. The queue is **not** wired into CI:
> regenerate it by hand after each version.
