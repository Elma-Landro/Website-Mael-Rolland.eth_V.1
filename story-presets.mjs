  ...
  stories: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          bridgeEntityIds: [‘Gouvernance polycentrique’, ‘Monétisation des cryptomonnaies’],
          cameraPreset: ‘wide’
        },
        {
          id: ‘m7’,
      ...
      steps: [
        {
          ...
          bridgeEntityIds: [‘Bitcoin Core (repo)’, ‘Développeurs Core (mainteneurs avec accès commit)’],
          cameraPreset: ‘tight’
        },
        {
          id: ‘q2’,
          ...
          cameraPreset: ‘cluster’,
          allowedRelationTypes: [‘partOf’, ‘maintains’, ‘relatedTo’, ‘governance’, ‘usedIn’, ‘debatedIn’]
        },
        {
          id: ‘q3’,
          title: ‘Les arènes’,
          ...
          cameraPreset: ‘cluster’,
          allowedRelationTypes: [‘debatedIn’, ‘usedIn’, ‘governance’, ‘relatedTo’, ‘demonstrates’]
        },
        {
          id: ‘q4’,
          title: ‘La thèse’,
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          bridgeEntityIds: [‘Bitcoin CVE 2018-17144’, ‘Crise de vulnérabilité’],
          cameraPreset: ‘cluster’,
          maxPrimaryEdges: 6
        },
        {
          ...
          bridgeEntityIds: [‘The DAO’, "Crise d’évolution"],
          cameraPreset: ‘cluster’,
          maxPrimaryEdges: 7
        },
        {
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          bridgeEntityIds: [‘Gouvernance polycentrique’, ‘Thèse centrale (infrastructures, crises, gouvernance polycentrique)’],
          cameraPreset: ‘cluster’,
    ...
    },
    {
      ...
      // Les bridgeEntityIds assurent la couture visuelle d’une scène à l’autre.
      id: ‘fil-de-preuves’,
