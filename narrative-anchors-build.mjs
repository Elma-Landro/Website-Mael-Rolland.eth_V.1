 ...
 *
 * Usage:
 *   node narrative-anchors-build.mjs [--input ./grc20-these-mael-rolland-v114.json] [--out ./narrative-anchors.json]
 */
...
const INPUT  = inputFlag  !== -1 ? args[inputFlag + 1]  : './grc20-these-mael-rolland-v114.json';
