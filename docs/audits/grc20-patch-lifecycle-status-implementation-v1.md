...
5. **Ledger et file ne peuvent pas se contredire en silence** : un patch mesuré `candidate_applied` mais absent de `patch-application-ledger.json` fait échouer le script plutôt que de produire un bloc d'apparence complète.
