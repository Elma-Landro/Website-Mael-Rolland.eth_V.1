...
- Crisis-step intensity by story (title/body/focus-node keyword scan): `crises 4/4`, `structure-these 1/4`, `fil-de-preuves 3/6`, versus `monetisation-cryptos 0/5` and `qui-gouverne-reellement 0/4`.
